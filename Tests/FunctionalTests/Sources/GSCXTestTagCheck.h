...
/**
 *  Contains factory methods for creating GTXChecking instances that fail based on UIView tags,
 *  which enables more focused tests.
 */
@interface GSCXTestTagCheck : NSObject

/**
 *  Creates a GTXChecking instance with given name that fails UI elements with a given tag.
 *
